...
cd tmp
del /q *
start /b ffmpeg.exe -thread_queue_size 4096 -f dshow -i video="screen-capture-recorder" -thread_queue_size 4096 -f dshow -i audio="virtual-audio-capturer" -acodec aac -g 120 -c:v h264_nvenc -preset llhq -profile:v high -pix_fmt yuv420p -f hls -hls_time 1.0 -hls_delete_threshold 2 -hls_flags delete_segments+append_list  out.m3u8
